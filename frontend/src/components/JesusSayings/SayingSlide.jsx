...
//
// 수정사항:
// 1. 슬라이드 본문 텍스트에 maxWidth + 중앙정렬 적용
// 2. 하단 CTA 바에 maxWidth 적용
// 3. 컨텍스트 패널 maxWidth 통일
// ============================================================
...
// ── 공통 maxWidth (슬라이드 콘텐츠 + 패널 + CTA 모두 동일) ──
const MAX_W = '860px';
    ...
    >
                  ...
                  {['krv', 'new'].map(t => (
                    <button
                      ...
                      style={{
                        ...
                        fontSize: '11px', fontWeight: trans === t ? 600 : 400,
          ...
          <>
            <button
              ...
              style={{
                ...
                cursor: 'pointer', color: 'rgba(255,255,255,0.80)', transition: 'background 0.2s', zIndex: 10,
              }}
          ...
          <div style={{ display: 'flex', gap: '0', borderBottom: '1px solid #e9e4dc' }}>
            {CTX_TABS.map(tab => (
              <button
                ...
                style={{
                  padding: '14px 20px',
                  fontSize: '13px', fontWeight: ctxTab === tab.key ? 600 : 400,
                    ...
                    {saying.keywords.map((kw, i) => (
                      <div key={i} style={{
                        ...
                        <div style={{ flexShrink: 0, minWidth: '120px' }}>
                          <p style={{ fontSize: '15px', fontWeight: 700, color: '#3C3489', marginBottom: '2px' }}>{kw.word}</p>
                          <p style={{ fontSize: '12px', color: '#7F77DD', fontStyle: 'italic', marginBottom: '1px' }}>{kw.original}</p>
                          <p style={{ fontSize: '11px', color: '#9ca3af' }}>{kw.transliteration}</p>
                        </div>
                        <div style={{ flex: 1, minWidth: '200px' }}>
                          <p style={{ fontSize: '13px', lineHeight: 1.8, color: '#374151', fontFamily: "'Gowun Batang', serif", margin: 0 }}>
                            {kw.meaning}
                          </p>
                        </div>
                      </div>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e9e4dc' }}>
        <div style={{
          ...
          <p style={{ fontSize: '13px', color: '#6b7280', fontFamily: "'Gowun Batang', serif", margin: 0 }}>
            오늘 말씀을 더 깊이 탐구해 보세요
          </p>
