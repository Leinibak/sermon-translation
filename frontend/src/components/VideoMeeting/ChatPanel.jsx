// frontend/src/components/VideoMeeting/ChatPanel.jsx
...
/**
 * 채팅 토글 버튼 (ControlBar에 추가용)
 */
export function ChatToggleButton({ onClick, unreadCount = 0 }) {
  return (
    <button
      onClick={onClick}
      className="relative p-3 bg-white text-gray-900 rounded-full hover:bg-gray-200 transition"
      title="채팅 열기"
    >
